...
import manandhiman.ny_times_reader_unofficial.adapters.PopularNewsRecyclerViewAdapter.ViewHolder
import manandhiman.ny_times_reader_unofficial.model.popular.PopularNewsSingleResult

class PopularNewsRecyclerViewAdapter(private val list: List<PopularNewsSingleResult>): RecyclerView.Adapter<ViewHolder>() {
